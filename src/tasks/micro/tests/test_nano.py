...
class TestRepetitionTasks(unittest.TestCase):
    ...
    """
        ...
        def testTask0(self):
            ...
            later) This leads to 1 / 32 correct ratio
        ...
        def testTask1(self):
            ...
            # With a patient teacher you have to wait for the 8 bits of the task + 1 of the separator
        ...
        def testTask10(self):
            ...
            # If you didn't put a 1 in the 8th bit, you are lost no matter what you do on the 9th bit
